...
env.Prepend(
    CPPPATH=[
        ...
        join(IDF_DIR, "components", "lwip", "include", "apps"),
        join(IDF_DIR, "components", "lwip", "lwip", "src", "include"),
        join(IDF_DIR, "components", "lwip", "port", "esp32", "include"),
        join(IDF_DIR, "components", "lwip", "port", "esp32", "include", "arch"),
        join(IDF_DIR, "components", "lwip", "include_compat"),
        join("$PROJECTSRC_DIR"),
        ...
        join(IDF_DIR, "components", "esp_event", "include"),
        join(IDF_DIR, "components", "esp_ringbuf", "include"),
        join(IDF_DIR, "components", "esp_http_server", "include"),
        join(IDF_DIR, "components", "esp_https_server", "include"),
        join(IDF_DIR, "components", "tcp_transport", "include"),
        join(IDF_DIR, "components", "protobuf-c", "protobuf-c"),
        join(IDF_DIR, "components", "wifi_provisioning", "include"),
        join(IDF_DIR, "components", "protocomm", "include", "common"),
        join(IDF_DIR, "components", "protocomm", "include", "security"),
        join(IDF_DIR, "components", "protocomm", "include", "transports"),
        join(IDF_DIR, "components", "unity", "include"),
        join(IDF_DIR, "components", "unity", "unity", "src"),
